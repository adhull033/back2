...
export interface ApiFormForm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pageURL: Attribute.String & Attribute.Private;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPropertyProperty extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    location_city: Attribute.String & Attribute.Required;
    ...
    >;
    amenities: Attribute.Component<'amenities.amenities', true>;
    features: Attribute.Component<'features.features', true>;
    sqft: Attribute.Integer;
    bhk: Attribute.Integer & Attribute.Required;
    ...
    >;
    other: Attribute.RichText;
    brand_icon: Attribute.Media;
    description: Attribute.RichText;
    property_details: Attribute.Component<
    ...
    Pricing: Attribute.Component<'unit-pricing.unit-pricing', true>;
    Nearby: Attribute.Component<'nearby.nearby-location'>;
    Project: Attribute.Component<'project-overview.project-overview'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
